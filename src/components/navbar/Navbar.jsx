...
import { HeaderContainer, NavContainer, UlContainer } from "./navbar-styles";
    ...
    <HeaderContainer>
      <NavContainer>
        <Link to="/" className="nav__logo">
          <img
            src="/assets/imgs/logos/logo__pwrgen.webp"
            alt="Logo Powergen"
            className="img__logo"
          />
        </Link>
            ...
            >
              ...
              <ul className="dropdown__menu">
                ...
                <li>
                  ...
                  >
                    <LuArrowBigRightDash className="hand__icon" /> Alquiler
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    <LuArrowBigRightDash className="hand__icon" /> Ventas
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    <LuArrowBigRightDash className="hand__icon" /> Servicio
                    Técnico
                  </Link>
                </li>
              </ul>
